...
function displayPics(){
  ...
  // A let declaration is block scoped, and therefore only exists in the while loop with the condition viewed.length < 6. We cannot log the variable outside of the while loop because it does not exist.
  console.log(viewed);
